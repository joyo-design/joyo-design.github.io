      ...
      value: (v) => {
        ...
        switch (v) {
          ...
          case "copy":
            ...
            break;
          case "reset":
            data.display.element[data.display.key].layer[variable.layer] = (data.display.element[data.display.key].layer[variable.layer].type == "text")?JSON.parse(`${JSON.stringify(variable.raw.text)}`):JSON.parse(`${JSON.stringify(variable.raw.image)}`);
            break;
          case "delete":
    ...
    },
    {
      ...
      value: (v=null) => {
        ...
        if (tempdata() && variable.save.status) {
          ...
          variable.save.mockup.data = [];
          variable.save.raw.data = [];
